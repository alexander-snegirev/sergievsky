...
WSGI_APPLICATION = 'sergievsky.wsgi.application'
...
CKEDITOR_UPLOAD_PATH = "uploading_images_blog_posts/"
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar_SergievskyToolbarConfig': [
        ...
        'toolbar': 'SergievskyToolbarConfig',
        'tabSpaces': 4,
        'extraPlugins': ','.join([
            'uploadimage',
            'autolink',
